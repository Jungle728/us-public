...
export const demoData: PanelData = {
  clients: [
    { id: 1, enable: true, name: "lhl", inbounds: [1, 2], volume: 500 * 1024 ** 3, expiry: 0, down: 18.4 * 1024 ** 3, up: 8.7 * 1024 ** 3, desc: "Main account", group: "aaitr-production", remark: "lhl", createdAt: now - 86400 * 16, onlineAt: now - 42 },
    { id: 2, enable: true, name: "wzd", inbounds: [1, 2], volume: 200 * 1024 ** 3, expiry: now + 86400 * 92, down: 62.1 * 1024 ** 3, up: 4.2 * 1024 ** 3, desc: "Production", group: "aaitr-production", remark: "wzd", createdAt: now - 86400 * 9, onlineAt: now - 440 },
    { id: 3, enable: true, name: "gpf", inbounds: [1, 2], volume: 100 * 1024 ** 3, expiry: now + 86400 * 31, down: 12.8 * 1024 ** 3, up: 1.4 * 1024 ** 3, desc: "Classmate", group: "aaitr-production", remark: "gpf", createdAt: now - 86400 * 5, onlineAt: now - 86400 },
    { id: 4, enable: false, name: "archive", inbounds: [1, 2], volume: 50 * 1024 ** 3, expiry: now - 86400, down: 50 * 1024 ** 3, up: 2.2 * 1024 ** 3, desc: "Expired", group: "archive", remark: "archive", createdAt: now - 86400 * 60, onlineAt: now - 86400 * 8 },
  ],
  inbounds: [
    ...
    { id: 3, type: "socks", tag: "aaitr-socks5", listen: "0.0.0.0", listen_port: 1080, tls_id: 0, users: ["lhl"] },
  ],
...
export const demoStatus: ServerStatus = {
  ...
  db: { clients: 4, inbounds: 3, outbounds: 3, endpoints: 0, services: 0, clientUp: 16.5 * 1024 ** 3, clientDown: 143.3 * 1024 ** 3 },
};
